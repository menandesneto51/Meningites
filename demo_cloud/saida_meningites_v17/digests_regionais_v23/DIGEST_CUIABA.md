...
- **Crítico** · Encerramento em risco/atrasado · CHAPADA DOS GUIMARAES | caso 1170015 — Priorizar encerramento com critério de confirmação e evolução preenchidos.
- **Crítico** · Encerramento em risco/atrasado · CHAPADA DOS GUIMARAES | caso 2865094 — Priorizar encerramento com critério de confirmação e evolução preenchidos.
- **Crítico** · Encerramento em risco/atrasado · CUIABA | caso 2208245 — Priorizar encerramento com critério de confirmação e evolução preenchidos.
- **Crítico** · Encerramento em risco/atrasado · CUIABA | caso 423289 — Priorizar encerramento com critério de confirmação e evolução preenchidos.
- **Crítico** · Encerramento em risco/atrasado · CUIABA | caso 666457 — Priorizar encerramento com critério de confirmação e evolução preenchidos.
- **Crítico** · Encerramento em risco/atrasado · CUIABA | caso 542606 — Priorizar encerramento com critério de confirmação e evolução preenchidos.
